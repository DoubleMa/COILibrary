...
public class IniKeyEntry(string tag, string strValue, string comment = null) : IniData(tag, comment) {
    public string StrValue { get; protected set; } = strValue;
...
public abstract class AIniKeyData(IniSectionData iniSectionData, string key, string comment = null, string tag = "add") : IniKeyEntry(tag, null, comment) {
    public IniSectionData IniSectionData { get; private set; } = iniSectionData;
